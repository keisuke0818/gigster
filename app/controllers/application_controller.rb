...
class ApplicationController < ActionController::Base
  ...
  def meta_defaults
    ...
    @meta_description = "Share gig in the World/ギグ共有サービス"
    ...
    @meta_og_title = "Gigster/Share gig in the World/ギグ共有サービス"
    @meta_og_type = "website"
    @meta_og_url = "http://gigster.jp/"
    @meta_og_image = "http://gigster.jp/assets/gigster.png"
    @meta_og_site_name = "Gigster"
    @meta_og_description = "Share gig in the World/ギグ共有サービス"
